# WSO2 Developer Platform Sample Node.js REST API - Reading List
...
Please refer to the WSO2 Developer Platform documentation under the [Develop a REST API](https://wso2.com/choreo/docs/develop-components/develop-services/develop-a-rest-api/#step-1-create-a-service-component-from-a-dockerfile) section to learn how to deploy the application.
